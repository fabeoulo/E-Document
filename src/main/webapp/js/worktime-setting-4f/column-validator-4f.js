...
var field_check_flow_logic = [
    ...
    {checkColumn: {name: ["weight"], equals: false, value: 0}, description: when_not_empty_or_null, targetColumns: [{name: packingFlow, keyword: ["PKG(WET)", "WET"]}]}
];
//Flow check logic
function fieldCheckM4f(postdata, preAssyVal, babFlowVal, testFlowVal, packingFlowVal) {
...
function checkWhenBiSamplingM4f(data, babFlowName) {
    var validationErrors = [];
...
function checkMacFieldIsValidM4f(data) {
    var validationErrors = [];
...
function registerEndsWithIfIeM4f() {
