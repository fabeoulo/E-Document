...
//            guiStyle: "bootstrap",
            ...
            subGridRowExpanded: function (subgrid_id, row_id) {
                ...
                subgrid.jqGrid({
                    url: '<c:url value="/FlowM4f/read_sub" />',
                    mtype: 'GET',
                    datatype: "json",
                    postData: {
                        id: row_id
                    ...
                    sortorder: "asc",
                    autowidth: true,
                    editurl: '<c:url value="/FlowM4f/update_sub" />',
                    jsonReader: {
                        root: "rows",
                        page: "page",
                        total: "total",
        ...
        grid.jqGrid('navGrid', '#pager',
                ...
                {
                    url: '<c:url value="/FlowM4f/update" />',
                ...
                {
                    url: '<c:url value="/FlowM4f/create" />',
                ...
                {
                    url: '<c:url value="/FlowM4f/delete" />',
                    zIndex: 9999,
                    reloadAfterSubmit: true
                },
                {
