...
<script>
    $(function () {
        var grid = $("#list");
        var tableName = "PreAssyM4f";

        grid.jqGrid({
            url: '<c:url value="/PreAssyM4f/read" />',
            datatype: 'json',
            mtype: 'GET',
            autoencode: true,
            colModel: [
        ...
        grid.jqGrid('navGrid', '#pager',
                ...
                {
                    url: '<c:url value="/PreAssyM4f/update" />',
                    dataheight: 350,
                    width: 450,
                ...
                {
                    url: '<c:url value="/PreAssyM4f/create" />',
                    dataheight: 350,
                    width: 450,
                ...
                {
                    url: '<c:url value="/PreAssyM4f/delete" />',
                    zIndex: 9999,
                    reloadAfterSubmit: true
                },
                {
