...
//            guiStyle: "bootstrap",
            ...
            colModel: [
                ...
                {label: '瓦數', name: "biPower", width: 60, searchrules: number_search_rule, searchoptions: search_decimal_options, editrules: {number: true, required: true}, editoptions: {defaultValue: '0'}},
...
//                {label: '測試SOP', name: "testSop", width: 100, search: true, searchrules: {required: true}, searchoptions: search_string_options, edittype: "textarea", editoptions: {maxlength: 500}},
        ...
        grid.jqGrid('setGroupHeaders', {
            ...
            groupHeaders: [
                ...
                {startColumnName: 'partNoAttributeMaintain', numberOfColumns: 6, titleText: '<em>料號屬性值維護</em>'},
