        ...
        function getEditRecord(id, modelName, version, startDate, endDate) {
            grid.jqGrid({
                ...
                colModel: [
                    ...
                    {label: 'T1自動測試', name: "t1Autotest", jsonmap: "0.t1Autotest", width: 100, searchrules: {required: true}, searchoptions: search_string_options},
                    ...
                    {label: 'T2自動測試', name: "t2Autotest", jsonmap: "0.t2Autotest", width: 100, searchrules: {required: true}, searchoptions: search_string_options},
                    ...
                    {label: '組裝Check是否收集外部序號', name: "assyCheckSsn", jsonmap: "0.assyCheckSsn", width: 80, searchrules: date_search_rule, searchoptions: search_string_options, editoptions: {defaultValue: '0'}},
                    {label: '掛卡產生客戶序號', name: "ssnOnTag", jsonmap: "0.ssnOnTag", width: 100, searchrules: date_search_rule, searchoptions: search_string_options, editoptions: {defaultValue: '0'}},
                    {label: '客戶序號卡關前綴碼', name: "ssnPrefix", jsonmap: "0.ssnPrefix", width: 100, searchrules: date_search_rule, searchoptions: search_string_options, editoptions: {defaultValue: '0'}},
                    {label: '客戶序號長度設定', name: "ssnLength", jsonmap: "0.ssnLength", width: 80, searchrules: date_search_rule, searchoptions: search_string_options, editoptions: {defaultValue: '0'}},
                    ...
                    {label: 'AssyInput標籤名稱', name: "labelAssyInput", jsonmap: "0.labelAssyInput", width: 100, searchrules: date_search_rule, searchoptions: search_string_options, editoptions: {defaultValue: '0'}},
                    ...
                    {label: '專案機種出貨棧板需求', name: "shippingPallet", jsonmap: "0.shippingPallet", width: 80, searchrules: number_search_rule, searchoptions: search_decimal_options},
