        ...
        function getEditRecord(id, modelName, version, startDate, endDate) {
            grid.jqGrid({
                ...
                colModel: [
                    ...
                    {label: 'preAssy(PI)', name: "pi", jsonmap: "0.pi", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: 'SL', name: "seal", jsonmap: "0.seal", width: 60, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: 'SL1', name: "seal1", jsonmap: "0.seal1", width: 60, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: 'OB', name: "opticalBonding", jsonmap: "0.opticalBonding", width: 60, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: 'OB1', name: "opticalBonding1", jsonmap: "0.opticalBonding1", width: 60, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: 'OB2', name: "opticalBonding2", jsonmap: "0.opticalBonding2", width: 60, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    ...
                    {label: '壓力鍋Cost', name: "pressureCookerCost", jsonmap: "0.pressureCookerCost", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: '高亮HB', name: "highBright", jsonmap: "0.highBright", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: 'AR film attachment', name: "arFilmAttachment", jsonmap: "0.arFilmAttachment", width: 120, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    ...
                    {label: '封/貼前框ASSY1', name: "bondedSealingFrame", jsonmap: "0.bondedSealingFrame", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: 'ASSY2', name: "assy2", jsonmap: "0.assy2", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    ...
                    {label: 'Clean room level', name: "cleanRoomLevel", jsonmap: "0.cleanRoomLevel", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    ...
                    {label: '瓦數', name: "biPower", jsonmap: "0.biPower", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options, formoptions: required_form_options},
...
//                    {label: '測試SOP', name: "testSop", jsonmap: "0.testSop", width: 100, searchrules: {required: true}, searchoptions: search_string_options, edittype: "textarea", editoptions: {maxlength: 500}},
                    ...
                    {label: 'Packing02標籤名稱', name: "labelPacking2", jsonmap: "0.labelPacking2", width: 100, searchrules: date_search_rule, searchoptions: search_string_options},
                    {label: 'Packing03標籤名稱', name: "labelPacking3", jsonmap: "0.labelPacking3", width: 100, searchrules: date_search_rule, searchoptions: search_string_options},
                    {label: 'Packing04標籤名稱', name: "labelPacking4", jsonmap: "0.labelPacking4", width: 100, searchrules: date_search_rule, searchoptions: search_string_options},
                    {label: 'Packing05標籤名稱', name: "labelPacking5", jsonmap: "0.labelPacking5", width: 100, searchrules: date_search_rule, searchoptions: search_string_options},
...
//                    ,{label: '工時細分', name: "splitFlag", jsonmap: "0.splitFlag", width: 60, searchrules: number_search_rule, searchoptions: search_string_options}
