...
<c:set var="tableName" value="WorktimeColumnGroupM4f" />
...
<script>
    $(function () {
        ...
        for (var i = 0; i < worktimeColM4f.length; i++) {
            var column = worktimeColM4f[i].name;
            var editable = worktimeColM4f[i].editable;
