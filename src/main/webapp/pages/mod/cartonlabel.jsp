<%-- 
    Document   : CartonLabel
    Created on : 2023/8/7, 下午 13:24:44
    Author     : Eric.Hong
--%>
...
<script>
    $(function () {
        var grid = $("#list");
        var tableName = "CartonLabel";

        grid.jqGrid({
            url: '<c:url value="/CartonLabel/read" />',
            datatype: 'json',
            mtype: 'GET',
            autoencode: true,
            colModel: [
                {label: 'id', name: "id", width:5, key: true, editable: true, editoptions: {readonly: 'readonly', disabled: true, defaultValue: "0"}},
        ...
        grid.jqGrid('navGrid', '#pager',
                ...
                {
                    url: '<c:url value="/CartonLabel/update" />',
                    dataheight: 350,
                    width: 450,
                ...
                {
                    url: '<c:url value="/CartonLabel/create" />',
                    dataheight: 350,
                    width: 450,
                ...
                {
                    url: '<c:url value="/CartonLabel/delete" />',
                    zIndex: 9999,
                    reloadAfterSubmit: true
                },
                {
