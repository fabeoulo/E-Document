    ...
    $(function () {
        ...
        $("#send").click(function () {
            ...
            if (!isGridInitialized) {
                ...
                grid.jqGrid('setGridParam', {url: '<c:url value="/AuditM4f/find" />', postData: {id: id, modelName: modelName, version: version, startDate: startDate, endDate: endDate}});
        ...
        function getEditRecord(id, modelName, version, startDate, endDate) {
            grid.jqGrid({
                ...
                colModel: [
                    ...
                    {label: 'R/I Time', name: "riTime", jsonmap: "0.riTime", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options, formoptions: required_form_options},
                    ...
                    {label: '包裝MAC總數', name: "macPackingQty", jsonmap: "0.macPackingQty", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: '包裝MAC單張筆數', name: "macPackingCount", jsonmap: "0.macPackingCount", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    {label: '視覺檢測', name: "visionInspect", jsonmap: "0.visionInspect", edittype: "select", width: 80, searchrules: {required: true}, searchoptions: search_string_options},
                    {label: '視覺檢測數量', name: "visionInspectQty", jsonmap: "0.visionInspectQty", width: 80, searchrules: number_search_rule, searchoptions: search_decimal_options},
