...
public class WorktimeUploadMesService {
    ...
    private boolean isMatPropertyChanged(Worktime prev, Worktime current) {
        boolean b = isModelNameChanged(prev, current)
                ...
                || !isEquals(prev.getLabelVariable11(), current.getLabelVariable11())
                || !isEquals(prev.getLabelVariable11AffId(), current.getLabelVariable11AffId())
                || !isEquals(prev.getLabelVariable12(), current.getLabelVariable12())
                || !isEquals(prev.getLabelVariable12AffId(), current.getLabelVariable12AffId())
